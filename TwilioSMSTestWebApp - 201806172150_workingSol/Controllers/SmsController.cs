...
namespace TwilioSMSTestWebApp.Controllers
{
    public class SmsController : TwilioController
    {
        ...
        //}
            ...
            // In a real application, I'd move this logic to a separate class but since it's simple string
            //reversal function, I guess it's OK to leave it here.
